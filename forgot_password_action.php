...
<!-- this page handles creating the session when the user logges in with the security key -->
...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
  ...
  # Check login.
  list ( $check, $data ) = validate ( $link, $_POST[ 'email' ], $_POST[ 'key' ] ) ;
