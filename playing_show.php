...
<!-- this page displays the selected show by the user -->
...
<body>
  ...
  if (mysqli_num_rows($r) == 1) {
    ...
    if ($_SESSION['isPaid'] == 1) {
      ...
      $q = "SELECT * FROM `media` WHERE seasonID = '$seasonID'";
      $r = mysqli_query($link, $q);
      ...
      if (mysqli_num_rows($r) > 0) {
        while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
          echo '<div class="row">
               <div class="col-sm-12 col-md-4">
                   <h4>Episode - ' . $row['episodeNumber'] . '</h4>
                   <hr>
                   <div class="embed-responsive embed-responsive-16by9">
                       <iframe width="560" height="315" src="' . $row['link'] . '" title="YouTube video player" 
                       frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                       </iframe>
                   </div>
                   <hr>
      ...
      # Or display message.
        ...
        echo '<p>There are currently no episodes.</p>';
      }
    }
