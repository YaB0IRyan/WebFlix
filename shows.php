...
<!-- this page handles the code for displaying all of the shows for the user -->
  ...
  GROUP BY mediaInfo.mediaInfoID" ;
	...
	<div class="col-sm d-flex justify-content-center">
        ...
        <h2>'. $row['title'].'</h2>
		  ...
		  <div class="card-body">
			<a href="playing_show.php?id='.$row['mediaInfoID'].'" class="btn btn-light btn-block">Watch</a>
	...
	# Or display message.
	else { echo '<p>There are currently no shows.</p>' ; }
