...
<!-- GRADED UNIT 2 -->
<!-- admin_view_movie.php -->

<!-- this page handles the code for the admin page when viewing all the movies -->
...
<body>
  ...
  <div class="container">
	<h1 class="text-center display-4">Movies</h1>
    <hr>
...
<?php
  ...
  WHERE genre.genreID = mediaGenre.genreID AND mediaGenre.mediaInfoID = mediaInfo.mediaInfoID AND mediaType.name = 'Movie'
  GROUP BY mediaInfo.mediaInfoID";
	...
	<div class="col-sm d-flex justify-content-center">
		<div class="card shadow p-3 mb-5 bg-dark rounded" style="width: 18rem;">
          ...
          <hr class="light-line">
            <a href="admin_edit_movie.php?currentID='.$row['mediaInfoID'].'" class="btn btn-secondary btn-block">Edit Movie</a>
            <a href="admin_delete_movie.php?currentID='.$row['mediaInfoID'].'" class="btn btn-outline-danger btn-block">Delete</a>
	...
	?>	
            <a href="admin_add_movie.php?currentID='.$row['mediaInfoID'].'" class="btn btn-outline-danger btn-block">Add New Movie</a>
