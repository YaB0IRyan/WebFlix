...
<!-- GRADED UNIT 2 -->
<!-- admin_edit_movie.php -->

<!-- this page handles the code to allow an admin to edit a movie -->
...
if (isset($_GET['currentID'])) $currentID = $_GET['currentID'];
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $q = "SELECT * FROM seasons WHERE mediaInfoID='$currentID'";
        ...
        if (empty($errors)) {
            $q = "UPDATE mediaInfo SET title='$movieTitle', image='$movieImageLink', description='$movieDescription', releaseDate='$movieReleseDate', language='$movieLanguage', trailerLink='$movieTrailerLink' WHERE mediaInfoID='$currentID'";
            $r = @mysqli_query($link, $q);
            if ($r) {
                echo '<p>1/3</p>';
            }
            ...
            $q = "UPDATE mediaGenre SET genreID='$movieGenreID' WHERE mediaInfoID='$currentID'";
            $r = @mysqli_query($link, $q);
            if ($r) {
                echo '<p>2/3</p>';
            }
            ...
            $q = "UPDATE media SET link='$movieMediaLink' WHERE seasonID='$seasonID'";
            $r = @mysqli_query($link, $q);
            if ($r) {
                echo '<p>3/3</p><br><P>Success! movie has been added, please click <a href="admin_view_movie.php">here</a></P>';
            }
    ...
    <div class="container">
        <h1 class="text-center display-4">Movie ID - <?php echo $currentID ?></h1>
        <div class="col-sm d-flex justify-content-center">
            <div class="card text-center">

                <div class="card-body">
                    <!-- Display body section with sticky form. -->
                    <form action="admin_edit_movie.php?currentID=<?php echo $currentID ?>" method="post">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <p class="text-center lead">Please make sure the genre already exists BEFORE adding the movie
                                <p>
                            </div>
